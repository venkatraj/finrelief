...
FinRelief is best suited for all types of site and uses Theme Customizer.

FinRelief WordPress Theme, Copyright (C) 2017, N. Venkat Raj
FinRelief is distributed under the terms of the GNU GPL

== Description ==  
FinRelief is an elegant WordPress Theme for Charity and Nonprofit organizations. To Promote the events, to Showcase all kinds of documents and much more. The theme is very versatile and can also be easily used by various types of corporations, business and any kind of sites. core feature of WordPress  Has 4 Footer Widget Areas and lot more of customizer options.

== Frequently Asked Questions == 
= Installation =
1. Download and unzip `finrelief` theme
2. Upload the `finrelief` folder to the `/wp-content/themes/` directory
...
* Screenshot Images is licensed under CC0 Public Domain License.
	* image © 2015 Pixabay, CC0 1.0 ,https://pixabay.com/en/african-children-beauty-finrelief-2044961/
	* image © 2015 Pixabay, CC0 1.0 ,https://pixabay.com/en/help-child-finrelief-voluntary-1265227/ 
